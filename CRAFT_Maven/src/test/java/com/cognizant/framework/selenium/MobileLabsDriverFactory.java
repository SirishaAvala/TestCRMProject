...
public class MobileLabsDriverFactory {
	...
	public static String forwardport, uploadcommand, connectcommand, FilePath, sendport, AppName, ReleaseCommand,
			DeviceName = null;
	...
	public static WebDriver getMobileLabsDriver(MobileExecutionPlatform executionPlatform, String deviceName,
		...
		case WEB_ANDROID:
		case ANDROID:
			System.out.println("Not Compatible for the selected Platform " + executionPlatform);
